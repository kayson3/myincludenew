...
import 'package:includenew/oldscreendata/fundwallet/fundwallet1.dart';
import 'package:includenew/oldscreendata/fundwallet/fundwallet2.dart';
import 'package:includenew/oldscreendata/fundwallet/fundwallet3.dart';
    ...
    return Dialog(
      ...
      child: Obx(
        () => Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          if (step.value == 1) FundWallet1(step: step),
          if (step.value == 2) FundWallet2(step: step),
          if (step.value == 3) FundWallet3(step: step),
          const SizedBox(
            // width: 250,
            height: 10,
          ),
