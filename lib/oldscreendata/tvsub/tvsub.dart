...
import 'package:includenew/oldscreendata/tvsub/tvsub1.dart';
import 'package:includenew/oldscreendata/tvsub/tvsub2.dart';

class TvSub extends StatelessWidget {
  RxInt step = 1.obs;
  TvSub({super.key});
    ...
    return Dialog(
      ...
      child: Obx(
        () => Column(mainAxisSize: MainAxisSize.min, children: [
          Container(
            ...
            child: Row(
              children: [
                ...
                const Text('TV/Cable Subscription',
          ...
          //   height: 10,
          // ),
          if (step.value == 1) Tvsub1(step: step),
          if (step.value == 2) Tvsub2(step: step),
