...
import 'package:includenew/oldscreendata/power/powersubscription1.dart';
import 'package:includenew/oldscreendata/power/powersubscription2.dart';

class PowerSub extends StatelessWidget {
  RxInt step = 1.obs;
  PowerSub({super.key});
    ...
    return Dialog(
      ...
      child: Obx(
        () => Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          //   height: 10,
          // ),
          if (step.value == 1) PowerSub1(step: step),
          if (step.value == 2) PowerSub2(step: step),
