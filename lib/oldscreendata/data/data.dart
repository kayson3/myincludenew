...
import 'package:includenew/oldscreendata/data/data1.dart';
import 'package:includenew/oldscreendata/data/data2.dart';
    ...
    return Dialog(
      ...
      child: Obx(
        () => Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          //   height: 10,
          // ),
          if (step.value == 1) Data1(step: step),
          if (step.value == 2) Data2(step: step),
