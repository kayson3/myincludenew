...
import 'package:includenew/oldscreendata/airtime/airtime1.dart';
import 'package:includenew/oldscreendata/airtime/airtime2.dart';

// import 'package:includenew/screens/airtime/airtime1.dart';
// import 'package:includenew/screens/airtime/airtime2.dart';
    ...
    return Dialog(
      ...
      child: Obx(
        () => Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          //   height: 10,
          // ),
          if (step.value == 1) Airtime1(step: step),
          if (step.value == 2) Airtime2(step: step),
