...
import 'package:includenew/screens_three/home.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 25.0),
                    child: Text(
                      'Turn on your biometric & create App lock PIN for your account.',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                      ...
                      child: Button(
                        ...
                        onTap: () {
                          if (_formKey.currentState!.validate()) {
                            Constants.store.write("PIN", pinController.text);
                            Get.to(() => Home());
                          }
                        },
                      ),
